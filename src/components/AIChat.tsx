      ...
      <div className="border-t border-gray-200 p-4">
        <div className="flex gap-2">
          <input
            ...
            className="flex-1 px-3 py-2 bg-white text-gray-900 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 placeholder-gray-500"
            disabled={isLoading}
          />
          <button
            onClick={handleSend}
