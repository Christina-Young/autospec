        ...
        <div className="bg-white rounded-lg p-6 w-96 shadow-xl">
          ...
          <div className="mb-4">
            ...
            <input
              ...
              className="w-full px-3 py-2 bg-white text-gray-900 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 placeholder-gray-500"
